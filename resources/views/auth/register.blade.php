        ...
        <div class="w-full md:w-1/2 bg-white flex justify-center items-start md:items-center p-8 md:p-16 relative">
            ...
            <div class="w-full max-w-md mt-16 md:mt-0">
                ...
                <div class="mb-10 text-center md:text-left">
                    ...
                    <h2 class="text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight">Buat Akun Baru</h2>
                    <p class="text-gray-600 mt-2">Bergabung dengan tim kami. Isi data Anda.</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative mt-1">
                            ...
                            <x-text-input id="name" class="block mt-1 w-full pl-10 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg h-12" type="text" name="name" :value="old('name')" required autofocus placeholder="Nama Anda" />
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative mt-1">
                            ...
                            <x-text-input id="email" class="block mt-1 w-full pl-10 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg h-12" type="email" name="email" :value="old('email')" required placeholder="nama@email.com" />
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative mt-1">
                            ...
                            <x-text-input id="password" class="block mt-1 w-full pl-10 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg h-12" type="password" name="password" required autocomplete="new-password" placeholder="Min. 8 karakter" />
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative mt-1">
                            ...
                            <x-text-input id="password_confirmation" class="block mt-1 w-full pl-10 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg h-12" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="Konfirmasi password Anda" />
                        </div>
                    ...
                    <div class="mt-10 text-center border-t pt-8">
                        ...
                        <a href="{{ route('login') }}" class="mt-3 inline-flex items-center justify-center w-full bg-emerald-100 hover:bg-emerald-200 text-emerald-800 font-semibold h-12 rounded-lg transition duration-150 gap-2 border border-emerald-200">
                            Masuk ke Dashboard
                        </a>
                    </div>
                </form>
