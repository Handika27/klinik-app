    ...
    <div class="min-h-screen flex">
        ...
        <div class="hidden md:flex md:w-1/2 bg-indigo-600 p-12 text-white flex-col justify-center relative overflow-hidden">
            ...
            <div class="relative z-10 mt-12 text-center md:text-left">
                <h1 class="text-4xl md:text-5xl font-extrabold leading-tight tracking-tight">Your Health, <br>Simply Managed.</h1>
                <p class="text-indigo-100 mt-4 max-w-md">Modern clinical workflow and monitor platform for healthcare facility.</p>
            </div>
        </div>
        ...
        <div class="w-full md:w-1/2 bg-white flex justify-center items-start md:items-center p-8 md:p-16 relative">
            ...
            <div class="w-full max-w-md mt-16 md:mt-0">
                ...
                <div class="mb-10 text-center md:text-left">
                    ...
                    <h2 class="text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight">Access Dashboard</h2>
                    <p class="text-gray-600 mt-2">Welcome back! Input your credentials.</p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative mt-1">
                            ...
                            <x-text-input id="email" class="block mt-1 w-full pl-10 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg h-12" type="email" name="email" :value="old('email')" required autofocus placeholder="name@clinic.com" />
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative mt-1">
                            ...
                            <x-text-input id="password" class="block mt-1 w-full pl-10 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg h-12" type="password" name="password" required placeholder="Min. 8 characters" />
                        </div>
                    ...
                    <div class="mt-10 text-center border-t pt-8">
                        <p class="text-gray-600">New professional?</p>
